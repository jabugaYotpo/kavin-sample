...
function App() {
  //Instance ID
  let InstanceId_Widget = "711996";
  let InstanceId_QA = "";
  let InstanceId_SEO = "736526";
  let InstanceId_Carousel = "";
  let InstanceId_StarRating = "711995";
  let InstanceId_PromotedProd = "741851";
  let InstanceId_UgcGallery = "";
  let InstanceId_ReviewsTab = "741852";
